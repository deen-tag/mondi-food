...
export const DEFAULT_PRODUCTS = [
  ...
  // Burgers (Mondi Night)
  { id: 'nb1', categoryId: 'burger', name: 'Le Classique', price: 11.90, desc: 'Steak haché, salade, tomate, oignons, sauce burger maison', img: '/images/night/burger-classique.png', order: 10 },
  { id: 'nb2', categoryId: 'burger', name: 'Le Cheese', price: 12.90, desc: 'Steak haché, cheddar fondant, salade, tomate, sauce burger maison', img: '/images/night/burger-cheese.png', order: 20 },
  { id: 'nb3', categoryId: 'burger', name: 'Le Bacon', price: 13.90, desc: 'Steak haché, bacon grillé, cheddar, oignons caramélisés, sauce fumée', img: '/images/night/burger-bacon.png', order: 30 },
  { id: 'nb4', categoryId: 'burger', name: 'Le Chicken', price: 13.90, desc: 'Poulet croustillant, salade, tomate, sauce burger maison', img: '/images/night/burger-chicken.png', order: 40 },
  { id: 'nb5', categoryId: 'burger', name: 'Le Montagnard', price: 14.90, desc: 'Steak haché, reblochon fondant, oignons caramélisés, sauce montagnarde', img: '/images/night/burger-montagnard.png', order: 50 },
  { id: 'nb6', categoryId: 'burger', name: 'Le Spécial Mondi', price: 15.90, desc: 'Double steak, cheddar, bacon, oignons frits, sauce signature Mondi', img: '/images/night/burger-special-mondi.png', badge: 'SIGNATURE', order: 60 },
  // Pâtes (Mondi Night)
  { id: 'np1', categoryId: 'pate', name: 'Penne Bolognaise', price: 11.90, desc: 'Sauce tomate mijotée, viande hachée, parmesan', img: '/images/night/pates-bolognaise.png', order: 10 },
  { id: 'np2', categoryId: 'pate', name: 'Penne Carbonara', price: 12.90, desc: 'Crème, lardons, parmesan, poivre', img: '/images/night/pates-carbonara.png', order: 20 },
  { id: 'np3', categoryId: 'pate', name: 'Penne Poulet Crème', price: 13.90, desc: 'Poulet rôti, crème, champignons, parmesan', img: '/images/night/pates-poulet-creme.png', order: 30 },
  { id: 'np4', categoryId: 'pate', name: 'Penne 4 Fromages', price: 13.90, desc: 'Mozzarella, gorgonzola, chèvre, parmesan', img: '/images/night/pates-4-fromages.png', order: 40 },
  { id: 'np5', categoryId: 'pate', name: 'Penne Épicées', price: 13.90, desc: 'Sauce tomate relevée, piment, chorizo', img: '/images/night/pates-epicees.png', hot: true, order: 50 },
