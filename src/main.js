...
${tile('pannuezo','/images/pannuezo-hero.jpg','PANNUEZO','Ultra fondant · généreusement garni')}
${tile('pizza','/images/pizza-hero.jpg','PIZZA','Pâte artisanale · ingrédients frais')}</section>
...
function menu(){
 ...
 return `<section class="menuTop"><button class="back" data-go="home">←</button><div class="crumb">Accueil　›　${S.type==='pizza'?'Pizza':'Pannuezo'}</div><div class="menuHero"><div><i>${S.type==='pizza'?'PIZZA':'PANNUEZO'}</i><h1>${S.type==='pizza'?'PIZZA':'PANNUEZO'}</h1><p>${S.type==='pizza'?'Pizzas artisanales cuites à la perfection avec des ingrédients frais et une pâte maison moelleuse et croustillante.':'Découvrez nos Pannuezo ultra fondants, généreusement garnis et préparés avec des ingrédients de qualité.'}</p></div><img src="${S.type==='pizza'?'/images/pizza-hero.jpg':'/images/pannuezo-hero.jpg'}"></div>
