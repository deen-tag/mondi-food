...
const PATHS = {
  ...
  whatsapp: "<path d='M20.5 3.5a10.5 10.5 0 0 0-17.8 11L2 21l6.7-.7a10.5 10.5 0 0 0 15.2-9.3c0-2.8-1.1-5.5-3.4-7.5Z' fill='none'/><path d='M8.4 7.6c.3-.6.6-.6.9-.6h.7c.2 0 .5 0 .7.6.3.6.9 2 .9 2.1.1.2.1.4 0 .6-.1.2-.2.3-.4.5l-.5.6c-.2.2-.3.4-.1.7.2.3.8 1.3 1.7 2.1 1.2 1 2.1 1.3 2.4 1.5.3.2.5.1.7-.1l.7-.8c.2-.3.4-.2.7-.1l1.9.9c.3.1.5.2.5.4.1.5.1 1-.1 1.5-.2.5-1.2 1.1-1.7 1.1-.5.1-1 .1-3.4-.9-2.9-1.2-4.7-4.1-4.9-4.3-.1-.2-1.1-1.5-1.1-2.8 0-1.4.7-2 1-2.3Z' fill='currentColor' stroke='none'/>",
